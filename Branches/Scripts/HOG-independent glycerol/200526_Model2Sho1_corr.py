...
def simulate_sln1_experiment(inits, total_protein, sig, learned_params, time):
    base_osmo, k1, K1, k2, K2, k3, K3, k4, K4, k5, k6, K56, k7, K7, k8, k9, K9, k10, K10, k11, k12 = learned_params #16
    learned_params = base_osmo, k1, K1, 0, 0, k3, K3, 0, 0, k5, 0, K56, k7, K7, k8, k9, K9, k10, K10, k11, k12
    #solve odes:
    odes = odeint(model, inits, time, args=(total_protein, sig, learned_params))
    return odes
...
def simulate_sho1_experiment(inits, total_protein, sig, learned_params, time):
    base_osmo, k1, K1, k2, K2, k3, K3, k4, K4, k5, k6, K56, k7, K7, k8, k9, K9, k10, K10, k11, k12 = learned_params #16
    learned_params = base_osmo, 0, 0, k2, K2, 0, 0, k4, K4, 0, k6, K56, k7, K7, k8, k9, K9, k10, K10, k11, k12
    #solve odes:
    odes = odeint(model, inits, time, args=(total_protein, sig, learned_params))
    return odes
...
if __name__ == '__main__':
    ...
    #base filename
    save_filename = '200526_Model2Sho1_corr.txt'
...
#    sho1_folder = base_folder + 'Sho1_phospho'
    ...
    Fps1_tot = molarity_conversion(1941)
    total_protein = [Sln1_tot, Sho1_tot, Hog1_tot, Fps1_tot, 0] #mM
    ...
    Fps1 = 0.01 * Fps1_tot
    Glycerol = 0.0001
    inits = [Sln1, Sho1, Hog1A, Fps1, Glycerol]
