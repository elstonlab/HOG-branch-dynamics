...
def scorefxn1(inits, total_protein, learned_params):
    ...
    for ss in all_ss:
        ...
        if (check < 0).any():
            # print(((9*5)*100)**2)
            return ((63+69+18*2+27)*100)**2 #if sims were the oppsite of the data (not possible)
...
if __name__ == '__main__':
    ...
    #base filename
    save_filename = '200518_Model1Sho1ss_v013.txt'
    ...
    Sln1_tot = molarity_conversion(584)
    Sho1_tot = molarity_conversion(120)
    Pbs2_tot = molarity_conversion(2282)
    Hog1_tot = molarity_conversion(5984)
    Sln1_on = 1
    Sho1_on = 1
    ...
    # Parameter ranges
    number_of_params = 24
    minimums = [-4, -4, -8, -8, -4, -4,
                -4, -4, -4, -4, -4, -4,
                -4, -4, -4, -4, -4, -4,
                -4, -4, -4, -4, -4, -4]

    maximums = [4, 4, 2, 2, 4, 4,
                4, 4, 4, 4, 4, 4,
                4, 4, 4, 4, 4, 4,
                4, 4, 4, 4, 4, 4]
