...
def simulate_sln1_experiment(inits, total_protein, sig, learned_params, time):
    base_osmo, k1, K1, k2, K2, k3, K3, k4, K4, k5f, k5r, k6f, k6r, k7, K7, k8, k10, kcat = learned_params #16
    learned_params = base_osmo, k1, K1, 0, 0, k3, K3, 0, 0, k5f, k5r, 0, 0, k7, K7, k8, k10, kcat
    #solve odes:
    odes = odeint(model, inits, time, args=(total_protein, sig, learned_params))
    return odes
...
def simulate_sho1_experiment(inits, total_protein, sig, learned_params, time):
    base_osmo, k1, K1, k2, K2, k3, K3, k4, K4, k5f, k5r, k6f, k6r, k7, K7, k8, k10, kcat = learned_params #16
    learned_params = base_osmo, 0, 0, k2, K2, 0, 0, k4, K4, 0, 0, k6f, k6r, k7, K7, k8, k10, kcat
    #solve odes:
    odes = odeint(model, inits, time, args=(total_protein, sig, learned_params))
    return odes
...
if __name__ == '__main__':
    ...
    #base filename
    save_filename = '200526_Branchesmodel2_v3.txt'
