...
def model(initials,t,total_protein,sig,params):
    ...
    dHog1_AC = (k5 * Sln1 + k6 * Sho1 + k14 * Hog1_AC) * Hog1_IC - k7 * Hog1_AC - (k8 + k15 * ((base_osmo + k1 * sig)/(1+Glycerol/beta))) * Hog1_AC + k9B * Hog1_AN
    dHog1_AN = (k8 + k15 * ((base_osmo + k1 * sig)/(1+Glycerol/beta))) - k9B * Hog1_AN - k10 * Hog1_AN
...
if __name__ == '__main__':
    ...
    #base filename
    save_filename = '200227_Model28.txt'
    ...
    # Paths to local data
#    base_folder = 'C:/Users/Rozemarijn/Documents/Universiteit/Masterstage2/Research/Modelling/Input/'
#    wt_phospho_folder = base_folder + 'WT_phospho'
#    wt_nuc_folder = base_folder + 'WT_nuc'
