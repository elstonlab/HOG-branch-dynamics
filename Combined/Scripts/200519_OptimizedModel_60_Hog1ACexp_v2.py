...
def model(initials,t,total_protein,sig,params):
    ...
    dHog1_AC = (k5 * Sln1 + k6 * Sho1 + k14 * Hog1_AC) * Hog1_IC / (K56 + Hog1_IC) - k7 * Hog1_AC / (K7 + Hog1_AC) - k8 * Hog1_AC + (k9B - k15 * Hog1_AC) * Hog1_AN
    dHog1_AN = k8 * Hog1_AC - (k9B - k15 * Hog1_AC) * Hog1_AN - k10 * Hog1_AN / (K10 + Hog1_AN)
...
if __name__ == '__main__':
    ...
    #base filename
    save_filename = '200519_OptimizedModel_60_Hog1ACexp_v2.txt'
