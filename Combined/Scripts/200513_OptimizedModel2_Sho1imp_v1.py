...
def model(initials,t,total_protein,sig,params):
    ...
    base_osmo, k1, K1, k2, K2, k3, K3, k4, K4, k5, k6, K5, K6, k7, K7, k8, K8, k9A, K9a, k9B, K9b, k10, K10, k11, K11, k12, k13, k14, K14, k15 = params #18
    ...
    dHog1_AC = k5 * Sln1 * Hog1_IC / (K5 + Hog1_IC) + k6 * Sho1 * Hog1_IC / (K6 + Hog1_IC) + k14 * Hog1_AC * Hog1_IC / (K14 + Hog1_IC) - k7 * Hog1_AC / (K7 + Hog1_AC) - (k8 + k15 * Sho1) * Hog1_AC / (K8 + Hog1_AC) + k9B * Hog1_AN / (K9b + Hog1_AN)
...
if __name__ == '__main__':
    ...
    #base filename
    save_filename = '200513_OptimizedModel2_Sho1imp_v1.txt'
