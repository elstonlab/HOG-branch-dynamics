...
def scorefxn1(inits, total_protein, learned_params):
    ...
    for dose, data_phospho, data_nuc in zip(hog1_doses, wt_phospho_data, wt_nuc_data):
        ...
        Hog1_nuc = (odes[:,2]+odes[:,3]+odes[:,4])/total_protein[1]*100 # percentage
...
if __name__ == '__main__':
    ...
    #base filename
    save_filename = '200615_OptimizedModel_60_Hog1ANcomp_v1.txt'
...
#    wt_nuc_folder = base_folder + '60percent/WT_nuc'
    ...
    Glycerol = 0.0001
    inits = [Sho1, Hog1_AC, Hog1_AN, Hog1_AN2, Hog1_IN, Glycerol]
