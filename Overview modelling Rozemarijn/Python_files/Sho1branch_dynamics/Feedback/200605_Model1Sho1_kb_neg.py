...
def simulate_sln1_experiment(inits, total_protein, sig, learned_params, time):
    base_osmo, beta, k1, K1, k2, K2, k3, K3, k4, K4, k5, k6, K56, k7, K7, k8, k10 = learned_params #16
    learned_params = base_osmo, 0, k1, K1, 0, 0, k3, K3, 0, 0, k5, 0, K56, k7, K7, k8, k10
    #solve odes:
    odes = odeint(model, inits, time, args=(total_protein, sig, learned_params))
    return odes
...
def simulate_sho1_experiment(inits, total_protein, sig, learned_params, time):
    base_osmo, beta,k1, K1, k2, K2, k3, K3, k4, K4, k5, k6, K56, k7, K7, k8, k10 = learned_params #16
    learned_params = base_osmo, beta, 0, 0, k2, K2, 0, 0, k4, K4, 0, k6, K56, k7, K7, k8, k10
    #solve odes:
    odes = odeint(model, inits, time, args=(total_protein, sig, learned_params))
    return odes
...
if __name__ == '__main__':
    ...
    #base filename
    save_filename = '200605_Model1Sho1_kb_neg.txt'
...
#    wt_folder = base_folder + 'WT'
#    sln1_folder = base_folder + 'Sln1'
#    sho1_folder = base_folder + 'Sho1'
    ...
    # Parameter ranges
    number_of_params = 17
    minimums = [1, -4, -4, -4, -4, -4, -4,
                -4, -4, -4, -4, -4, -4,
                -4, -4, -4, -4
        ]

    maximums = [2, 4, 4, 4, 4, 4, 4,
                4, 4, 4, 4, 4, 4,
                4, 4, 4, 4
        ]
