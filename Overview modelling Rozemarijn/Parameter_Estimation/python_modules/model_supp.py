...
def get_data(input):
    if input == 'long':
        ...
        base_folder = 'C:/Users/Rozemarijn/Documents/Universiteit/Masterstage2/Research/Modelling/Inputs/Prescaled_Input/'
        wt_phospho_folder = base_folder + 'WT_phospho'
        wt_nuc_folder = base_folder + '77percent/WT_nuc'
    elif input == '90percPbs2':
        ...
        base_folder = 'C:/Users/Rozemarijn/Documents/Universiteit/Masterstage2/Research/Modelling/Inputs/Ratio_input/'
        wt_phospho_folder = base_folder + 'WT_phospho'
        wt_nuc_folder = base_folder + 'WT_nuc'
    elif input == 'integ':
        base_folder = 'C:/Users/Rozemarijn/Documents/Universiteit/Masterstage2/Research/WT/'
    else:
        print('wrong input')
   ...
   # integ_time, integ_data = load_csv_data(base_folder)
