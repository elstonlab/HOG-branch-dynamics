 ...
 #       ax1.set_ylim(-5,10)
    ...
    for sig in doses:
        for params in top_params[:plt_top]:
                    ...
                    if ss:
                      #  base_osmo, k1, K1, k2, K2, k3, K3, k4, K4, k5, k6, K56, k7, K7, k8, k9, k10 = params #16
                       # params = base_osmo, k1, K1, k2, K2, k3, K3, k4, K4, k5, 0, K56, k7, K7, k8, k9, k10
                        ...
                        data = simulate_sln1_experiment(model_fxns.m, initials, params_constants, sig, params, time)
                elif Sho1:
                    if ss:
                        #base_osmo, k1, K1, k2, K2, k3, K3, k4, K4, k5, k6, K56, k7, K7, k8, k9, k10 = params #16
                ...
                hog1 = (data[:,2])/params_constants[1]*100
                glycerol = data[:,3]
                if param == 'phospho':
            ...
            if Sln1:
                if ss:
                  #  base_osmo, k1, K1, k2, K2, k3, K3, k4, K4, k5, k6, K56, k7, K7, k8, k9, k10 = params #16
                   # params = base_osmo, k1, K1, k2, K2, k3, K3, k4, K4, k5, 0, K56, k7, K7, k8, k9, k10
                    sln1_ss_inits = fsolve(model_fxns.m, initials, args=(0,params_constants, 0, params))
                    data = simulate_sln1_experiment(model_fxns.m, sln1_ss_inits, params_constants, dose, params, time)
                else:
                    data = simulate_sln1_experiment(model_fxns.m, initials, params_constants, dose, params, time)
            elif Sho1:
                if ss:
                   # base_osmo, k1, K1, k2, K2, k3, K3, k4, K4, k5, k6, K56, k7, K7, k8, k9, k10 = params #16
                   # params = base_osmo, k1, K1, k2, K2, k3, K3, k4, K4, 0, k6, K56, k7, K7, k8, k9, k10
                    sho1_ss_inits = fsolve(model_fxns.m, initials, args=(0,params_constants, 0, params))
                    data = simulate_sho1_experiment(model_fxns.m, sho1_ss_inits, params_constants, dose, params, time)
                else:
                    data = simulate_sho1_experiment(model_fxns.m, initials, params_constants, dose, params, time)
            else:
                if ss:
                    wt_ss_inits = fsolve(model_fxns.m, initials, args=(0,params_constants, 0, params))
