...
def OM2(initials,t,total_protein,sig,params, run_type=None):
    ...
    base_osmo, k2, K2, k4, K4, k6, K56, k7, K7, k8, K8, k9A, K9a, k9B, K9b, k10, K10, k11, K11, k12, k13, k15 = params #18
    ...
    dHog1_AC = k6 * Sho1  * Hog1_IC / (K56 + Hog1_IC) - k7 * Hog1_AC / (K7 + Hog1_AC) - (k8 + k15 * sig - Glycerol) * Hog1_AC / (K8 + Hog1_AC) + k9B * Hog1_AN / (K9b + Hog1_AN)
...
def OM_Hog1ACimp(initials,t,total_protein,sig,params, run_type=None):
    Sho1, Hog1_AC, Hog1_AN, Hog1_IN, Glycerol = initials
    Sho1_tot, Hog1_tot, _ = total_protein
    base_osmo, k2, K2, k4, K4, k6, K56, k7, K7, k8, K8, k9A, K9a, k9B, K9b, k10, K10, k11, K11, k12, k13, k15 = params #18
    ...
    dSho1 = (base_osmo + k2 * sig - Glycerol) * (Sho1_inactive) / (K2 + Sho1_inactive) - k4 * Sho1 / (K4 + Sho1)
    dHog1_AC = k6 * Sho1 * Hog1_IC / (K56 + Hog1_IC) - k7 * Hog1_AC / (K7 + Hog1_AC) - (k8 + k15 * Hog1_AC) * Hog1_AC / (K8 + Hog1_AC) + k9B * Hog1_AN / (K9b + Hog1_AN)
...
def OM_Hog1ANimp(initials,t,total_protein,sig,params, run_type=None):
    Sho1, Hog1_AC, Hog1_AN, Hog1_IN, Glycerol = initials
    Sho1_tot, Hog1_tot, _ = total_protein
    base_osmo, k2, K2, k4, K4, k6, K56, k7, K7, k8, K8, k9A, K9a, k9B, K9b, k10, K10, k11, K11, k12, k13, k15 = params #18
    ...
    dSho1 = (base_osmo + k2 * sig - Glycerol) * (Sho1_inactive) / (K2 + Sho1_inactive) - k4 * Sho1 / (K4 + Sho1)
    dHog1_AC = k6 * Sho1 * Hog1_IC / (K56 + Hog1_IC) - k7 * Hog1_AC / (K7 + Hog1_AC) - (k8 + k15 * Hog1_AN) * Hog1_AC / (K8 + Hog1_AC) + k9B * Hog1_AN / (K9b + Hog1_AN)
...
def OM_Sho1imp(initials,t,total_protein,sig,params, run_type=None):
    ...
    dSho1 = (base_osmo + k2 * sig - Glycerol) * (Sho1_inactive) / (K2 + Sho1_inactive) - k4 * Sho1 / (K4 + Sho1)
    dHog1_AC = k6 * Sho1 * Hog1_IC / (K56 + Hog1_IC) - k7 * Hog1_AC / (K7 + Hog1_AC) - (k8 + k15 * Sho1) * Hog1_AC / (K8 + Hog1_AC) + k9B * Hog1_AN / (K9b + Hog1_AN)
...
#OptimizedModel, import Sho1-dependent
def OM_Sho1impneg(initials,t,total_protein,sig,params, run_type=None):
    Sho1, Hog1_AC, Hog1_AN, Hog1_IN, Glycerol = initials
    Sho1_tot, Hog1_tot, _ = total_protein
    base_osmo, k2, K2, k4, K4, k6, K56, k7, K7, k8, K8, k9A, K9a, k9B, K9b, k10, K10, k11, K11, k12, k13, k15 = params #18
...
def OM_Hog1ACexp(initials,t,total_protein,sig,params, run_type=None):
    ...
    dSho1 = (base_osmo + k2 * sig - Glycerol) * (Sho1_inactive) / (K2 + Sho1_inactive) - k4 * Sho1 / (K4 + Sho1)
    dHog1_AC = k6 * Sho1 * Hog1_IC / (K56 + Hog1_IC) - k7 * Hog1_AC / (K7 + Hog1_AC) - k8 * Hog1_AC / (K8 + Hog1_AC) + (k9B - k15 * Hog1_AC) * Hog1_AN / (K9b + Hog1_AN)
...
def OM_Hog1ANexp(initials,t,total_protein,sig,params, run_type=None):
    ...
    dSho1 = (base_osmo + k2 * sig - Glycerol) * (Sho1_inactive) / (K2 + Sho1_inactive) - k4 * Sho1 / (K4 + Sho1)
    dHog1_AC = k6 * Sho1 * Hog1_IC / (K56 + Hog1_IC) - k7 * Hog1_AC / (K7 + Hog1_AC) - k8 * Hog1_AC / (K8 + Hog1_AC) + (k9B - k15 * Hog1_AN) * Hog1_AN / (K9b + Hog1_AN)
...
def OM_osmoexp(initials,t,total_protein,sig,params, run_type=None):
    ...
    dSho1 = (base_osmo + k2 * sig - Glycerol) * (Sho1_inactive) / (K2 + Sho1_inactive) - k4 * Sho1 / (K4 + Sho1)
    dHog1_AC = k6 * Sho1 * Hog1_IC / (K56 + Hog1_IC) - k7 * Hog1_AC / (K7 + Hog1_AC) - k8 * Hog1_AC / (K8 + Hog1_AC) + (k9B - (k15 * sig - Glycerol)) * Hog1_AN / (K9b + Hog1_AN)
...
#OptimizedModel, osmo-inhibited import
def OM_osmoimpneg(initials,t,total_protein,sig,params, run_type=None):
    Sho1, Hog1_AC, Hog1_AN, Hog1_IN, Glycerol = initials
    Sho1_tot, Hog1_tot, _ = total_protein
    base_osmo, k2, K2, k4, K4, k6, K56, k7, K7, k8, K8, k9A, K9a, k9B, K9b, k10, K10, k11, K11, k12, k13, k15 = params #18
...
def OM_Sho1exp(initials,t,total_protein,sig,params, run_type=None):
    ...
    dSho1 = (base_osmo + k2 * sig - Glycerol) * (Sho1_inactive) / (K2 + Sho1_inactive) - k4 * Sho1 / (K4 + Sho1)
    dHog1_AC = k6 * Sho1 * Hog1_IC / (K56 + Hog1_IC) - k7 * Hog1_AC / (K7 + Hog1_AC) - k8 * Hog1_AC / (K8 + Hog1_AC) + (k9B - k15 * Sho1) * Hog1_AN / (K9b + Hog1_AN)
...
#OptimizedModel, Sho1-inhibited export 2
def OM_Sho1exp2(initials,t,total_protein,sig,params, run_type=None):
    Sho1, Hog1_AC, Hog1_AN, Hog1_IN, Glycerol = initials
    Sho1_tot, Hog1_tot, _ = total_protein
    ...
    dSho1 = (base_osmo + k2 * sig - Glycerol) * (Sho1_inactive) / (K2 + Sho1_inactive) - k4 * Sho1 / (K4 + Sho1)
    dHog1_AC = (k6 * Sho1 + k14 * Hog1_AC) * Hog1_IC / (K56 + Hog1_IC) - k7 * Hog1_AC / (K7 + Hog1_AC) - k8 * Hog1_AC / (K8 + Hog1_AC) + (k9B - k15 * Sho1) * Hog1_AN / (K9b + Hog1_AN)
    dHog1_AN = k8 * Hog1_AC / (K8 + Hog1_AC) - (k9B - k15 * Sho1) * Hog1_AN / (K9b + Hog1_AN) - k10 * Hog1_AN / (K10 + Hog1_AN)
    dHog1_IN = k10 * Hog1_AN / (K10 + Hog1_AN) - k9A * Hog1_IN / (K9a + Hog1_IN) + k11 * Hog1_IC / (K11 + Hog1_IC)
    dGlycerol = k12 * Hog1_AC - k13 * Glycerol
...
def OM_Hog1ACcomp(initials,t,total_protein,sig,params, run_type=None):
    Sho1, Hog1_AC, Hog1_AC2, Hog1_AN, Hog1_IN, Glycerol = initials
    Sho1_tot, Hog1_tot, _ = total_protein
    base_osmo, k2, K2, k4, K4, k6, K56, k7, K7, k8, K8, k9A, K9a, k9B, K9b, k10, K10, k11, K11, k12, k13, k15, k16 = params #18
    ...
    dSho1 = (base_osmo + k2 * sig - Glycerol) * (Sho1_inactive) / (K2 + Sho1_inactive) - k4 * Sho1 / (K4 + Sho1)
    dHog1_AC = k6 * Sho1 * Hog1_IC / (K56 + Hog1_IC) - k7 * Hog1_AC / (K7 + Hog1_AC) - k8  * Hog1_AC / (K8 + Hog1_AC) + k9B * Hog1_AN / (K9b + Hog1_AN) - k15 * Hog1_AC + k16 * Hog1_AC2
    dHog1_AC2 = k15 * Hog1_AC - k16 * Hog1_AC2
    dHog1_AN = k8  * Hog1_AC / (K8 + Hog1_AC) - k9B * Hog1_AN / (K9b + Hog1_AN) - k10 * Hog1_AN / (K10 + Hog1_AN)
    dHog1_IN = k10 * Hog1_AN / (K10 + Hog1_AN) - k9A * Hog1_IN / (K9a + Hog1_IN) + k11 * Hog1_IC / (K11 + Hog1_IC)
    dGlycerol = k12 * Hog1_AC - k13 * Glycerol

    return dSho1, dHog1_AC, dHog1_AC2, dHog1_AN, dHog1_IN, dGlycerol

#OptimizedModel, Hog1AC-complex, version 2
def OM_Hog1ACcomp_v2(initials,t,total_protein,sig,params, run_type=None):
    Sho1, Hog1_AC, Hog1_AC2, Hog1_AN, Hog1_IN, Glycerol = initials
    Sho1_tot, Hog1_tot, C_tot, _ = total_protein
    base_osmo, k2, K2, k4, K4, k6, K56, k7, K7, k8, K8, k9A, K9a, k9B, K9b, k10, K10, k11, K11, k12, k13, k15, k16 = params #18

    Hog1_IC = Hog1_tot - Hog1_AC - Hog1_AN - Hog1_IN - Hog1_AC2
    Sho1_inactive = Sho1_tot - Sho1
    C_unbound = C_tot - Hog1_AC2
    ...
    dSho1 = (base_osmo + k2 * sig - Glycerol) * (Sho1_inactive) / (K2 + Sho1_inactive) - k4 * Sho1 / (K4 + Sho1)
    dHog1_AC = k6 * Sho1 * Hog1_IC / (K56 + Hog1_IC) - k7 * Hog1_AC / (K7 + Hog1_AC) - k8  * Hog1_AC / (K8 + Hog1_AC) + k9B * Hog1_AN / (K9b + Hog1_AN) - k15 * Hog1_AC + k16 * Hog1_AC2
    dHog1_AC2 = k15 * Hog1_AC * C_unbound - k16 * Hog1_AC2
    dHog1_AN = k8  * Hog1_AC / (K8 + Hog1_AC) - k9B * Hog1_AN / (K9b + Hog1_AN) - k10 * Hog1_AN / (K10 + Hog1_AN)
    dHog1_IN = k10 * Hog1_AN / (K10 + Hog1_AN) - k9A * Hog1_IN / (K9a + Hog1_IN) + k11 * Hog1_IC / (K11 + Hog1_IC)
    dGlycerol = k12 * Hog1_AC - k13 * Glycerol
...
def OM_Hog1ANcomp(initials,t,total_protein,sig,params, run_type=None):
    Sho1, Hog1_AC, Hog1_AN, Hog1_AN2, Hog1_IN, Glycerol = initials
    Sho1_tot, Hog1_tot, _ = total_protein
    base_osmo, k2, K2, k4, K4, k6, K56, k7, K7, k8, K8, k9A, K9a, k9B, K9b, k10, K10, k11, K11, k12, k13, k15, k16 = params #18
    ...
    dSho1 = (base_osmo + k2 * sig - Glycerol) * (Sho1_inactive) / (K2 + Sho1_inactive) - k4 * Sho1 / (K4 + Sho1)
    dHog1_AC = k6 * Sho1 * Hog1_IC / (K56 + Hog1_IC) - k7 * Hog1_AC / (K7 + Hog1_AC) - k8  * Hog1_AC / (K8 + Hog1_AC) + k9B * Hog1_AN / (K9b + Hog1_AN)
    ...
    return dSho1, dHog1_AC, dHog1_AN, dHog1_AN2, dHog1_IN, dGlycerol

#OptimizedModel, Hog1AN-complex, version 2
def OM_Hog1ANcomp_v2(initials,t,total_protein,sig,params, run_type=None):
    Sho1, Hog1_AC, Hog1_AN, Hog1_AN2, Hog1_IN, Glycerol = initials
    Sho1_tot, Hog1_tot, C_tot, _ = total_protein
    base_osmo, k2, K2, k4, K4, k6, K56, k7, K7, k8, K8, k9A, K9a, k9B, K9b, k10, K10, k11, K11, k12, k13, k15, k16 = params #18
    ...
    dHog1_AC = k6 * Sho1 * Hog1_IC / (K56 + Hog1_IC) - k7 * Hog1_AC / (K7 + Hog1_AC) - k8  * Hog1_AC / (K8 + Hog1_AC) + k9B * Hog1_AN / (K9b + Hog1_AN)
    dHog1_AN = k8  * Hog1_AC / (K8 + Hog1_AC) - k9B * Hog1_AN / (K9b + Hog1_AN) - k10 * Hog1_AN / (K10 + Hog1_AN) - k15 * Hog1_AN + k16 * Hog1_AN2
    dHog1_AN2 = k15 * Hog1_AN * C_unbound - k16 * Hog1_AN2
    dHog1_IN = k10 * Hog1_AN / (K10 + Hog1_AN) - k9A * Hog1_IN / (K9a + Hog1_IN) + k11 * Hog1_IC / (K11 + Hog1_IC)
    dGlycerol = k12 * Hog1_AC - k13 * Glycerol

    return dSho1, dHog1_AC, dHog1_AN, dHog1_AN2, dHog1_IN, dGlycerol

#OptimizedModel1, one branch
def OM1_onebranch(initials,t,total_protein,sig,params, run_type=None):
    Sho1, Hog1_AC, Hog1_AN, Hog1_IN, Glycerol = initials
    Sho1_tot, Hog1_tot, _ = total_protein
    base_osmo, k2, K2, k4, K4, k6, K6, k7, K7, k8, K8, k9A, K9a, k9B, K9b, k10, K10, k11, K11, k12, k13 = params #18
    ...
    dSho1 = (base_osmo + k2 * sig - Glycerol) * (Sho1_inactive) / (K2 + Sho1_inactive) - k4 * Sho1 / (K4 + Sho1)
    dHog1_AC = k6 * Sho1 * Hog1_IC / (K6 + Hog1_IC) - k7 * Hog1_AC / (K7 + Hog1_AC) - k8 * Hog1_AC / (K8 + Hog1_AC) + k9B * Hog1_AN / (K9b + Hog1_AN)
    dHog1_AN = k8 * Hog1_AC / (K8 + Hog1_AC) - k9B * Hog1_AN / (K9b + Hog1_AN) - k10 * Hog1_AN / (K10 + Hog1_AN)
    dHog1_IN = k10 * Hog1_AN / (K10 + Hog1_AN) - k9A * Hog1_IN / (K9a + Hog1_IN) + k11 * Hog1_IC / (K11 + Hog1_IC)
    dGlycerol = k12 * Hog1_AC - k13 * Glycerol
...
#OptimizedModel, Hog1AN negative active import
def OM_Hog1ANimpneg(initials,t,total_protein,sig,params, run_type=None):
    Sho1, Hog1_AC, Hog1_AN, Hog1_IN, Glycerol = initials
    Sho1_tot, Hog1_tot, _ = total_protein
    base_osmo, k2, K2, k4, K4, k6, K56, k7, K7, k8, K8, k9A, K9a, k9B, K9b, k10, K10, k11, K11, k12, k13, k15 = params #18
...
#OptimizedModel, Hog1AC negative active import
def OM_Hog1ACimpneg(initials,t,total_protein,sig,params, run_type=None):
    Sho1, Hog1_AC, Hog1_AN, Hog1_IN, Glycerol = initials
    Sho1_tot, Hog1_tot, _ = total_protein
    base_osmo, k2, K2, k4, K4, k6, K56, k7, K7, k8, K8, k9A, K9a, k9B, K9b, k10, K10, k11, K11, k12, k13, k15 = params #18
...
#OptimizedModel, Hog1AC negative inactive import
def OM_Hog1ACimpinneg(initials,t,total_protein,sig,params, run_type=None):
    Sho1, Hog1_AC, Hog1_AN, Hog1_IN, Glycerol = initials
    Sho1_tot, Hog1_tot, _ = total_protein
    base_osmo, k2, K2, k4, K4, k6, K56, k7, K7, k8, K8, k9A, K9a, k9B, K9b, k10, K10, k11, K11, k12, k13, k15 = params #18
    ...
    dHog1_AC = k6 * Sho1 * Hog1_IC / (K56 + Hog1_IC) - k7 * Hog1_AC / (K7 + Hog1_AC) - k8 * Hog1_AC / (K8 + Hog1_AC) + k9B * Hog1_AN / (K9b + Hog1_AN)
    dHog1_AN = k8 * Hog1_AC / (K8 + Hog1_AC) - k9B * Hog1_AN / (K9b + Hog1_AN) - k10 * Hog1_AN / (K10 + Hog1_AN)
    dHog1_IN = k10 * Hog1_AN / (K10 + Hog1_AN) - k9A * Hog1_IN / (K9a + Hog1_IN) + (k11 - k15 * Hog1_AC) * Hog1_IC / (K11 + Hog1_IC)
    dGlycerol = k12 * Hog1_AC - k13 * Glycerol

    return dSho1, dHog1_AC, dHog1_AN, dHog1_IN, dGlycerol

#OptimizedModel, Hog1AN negative inactive import
def OM_Hog1ANimpinneg(initials,t,total_protein,sig,params, run_type=None):
    Sho1, Hog1_AC, Hog1_AN, Hog1_IN, Glycerol = initials
    Sho1_tot, Hog1_tot, _ = total_protein
    base_osmo, k2, K2, k4, K4, k6, K56, k7, K7, k8, K8, k9A, K9a, k9B, K9b, k10, K10, k11, K11, k12, k13, k15 = params #18
    ...
    dHog1_AC = k6 * Sho1 * Hog1_IC / (K56 + Hog1_IC) - k7 * Hog1_AC / (K7 + Hog1_AC) - k8 * Hog1_AC / (K8 + Hog1_AC) + k9B * Hog1_AN / (K9b + Hog1_AN)
    dHog1_AN = k8 * Hog1_AC / (K8 + Hog1_AC) - k9B * Hog1_AN / (K9b + Hog1_AN) - k10 * Hog1_AN / (K10 + Hog1_AN)
    dHog1_IN = k10 * Hog1_AN / (K10 + Hog1_AN) - k9A * Hog1_IN / (K9a + Hog1_IN) + (k11 - k15 * Hog1_AN) * Hog1_IC / (K11 + Hog1_IC)
    dGlycerol = k12 * Hog1_AC - k13 * Glycerol

    return dSho1, dHog1_AC, dHog1_AN, dHog1_IN, dGlycerol

#OptimizedModel, Hog1AN positive inactive import
def OM_Hog1ANimpinpos(initials,t,total_protein,sig,params, run_type=None):
    Sho1, Hog1_AC, Hog1_AN, Hog1_IN, Glycerol = initials
    Sho1_tot, Hog1_tot, _ = total_protein
    base_osmo, k2, K2, k4, K4, k6, K56, k7, K7, k8, K8, k9A, K9a, k9B, K9b, k10, K10, k11, K11, k12, k13, k15 = params #18
...
#OptimizedModel, Hog1AC positive inactive import
def OM_Hog1ACimpinpos(initials,t,total_protein,sig,params, run_type=None):
    Sho1, Hog1_AC, Hog1_AN, Hog1_IN, Glycerol = initials
    Sho1_tot, Hog1_tot, _ = total_protein
    base_osmo, k2, K2, k4, K4, k6, K56, k7, K7, k8, K8, k9A, K9a, k9B, K9b, k10, K10, k11, K11, k12, k13, k15 = params #18
...
#OptimizedModel, Sho1 positive inactive import
def OM_Sho1impinpos(initials,t,total_protein,sig,params, run_type=None):
    Sho1, Hog1_AC, Hog1_AN, Hog1_IN, Glycerol = initials
    Sho1_tot, Hog1_tot, _ = total_protein
    base_osmo, k2, K2, k4, K4, k6, K56, k7, K7, k8, K8, k9A, K9a, k9B, K9b, k10, K10, k11, K11, k12, k13, k15 = params #18
    ...
    dHog1_AC = k6 * Sho1 * Hog1_IC / (K56 + Hog1_IC) - k7 * Hog1_AC / (K7 + Hog1_AC) - k8 * Hog1_AC / (K8 + Hog1_AC) + k9B * Hog1_AN / (K9b + Hog1_AN)
    dHog1_AN = k8 * Hog1_AC / (K8 + Hog1_AC) - k9B * Hog1_AN / (K9b + Hog1_AN) - k10 * Hog1_AN / (K10 + Hog1_AN)
    dHog1_IN = k10 * Hog1_AN / (K10 + Hog1_AN) - k9A * Hog1_IN / (K9a + Hog1_IN) + (k11 + k15 * Sho1) * Hog1_IC / (K11 + Hog1_IC)
    dGlycerol = k12 * Hog1_AC - k13 * Glycerol

    return dSho1, dHog1_AC, dHog1_AN, dHog1_IN, dGlycerol

#OptimizedModel, Sho1 negative inactive import
def OM_Sho1impinneg(initials,t,total_protein,sig,params, run_type=None):
    Sho1, Hog1_AC, Hog1_AN, Hog1_IN, Glycerol = initials
    Sho1_tot, Hog1_tot, _ = total_protein
    base_osmo, k2, K2, k4, K4, k6, K56, k7, K7, k8, K8, k9A, K9a, k9B, K9b, k10, K10, k11, K11, k12, k13, k15 = params #18
...
#OptimizedModel, osmo negative inactive import
def OM_osmoimpinneg(initials,t,total_protein,sig,params, run_type=None):
    Sho1, Hog1_AC, Hog1_AN, Hog1_IN, Glycerol = initials
    Sho1_tot, Hog1_tot, _ = total_protein
    base_osmo, k2, K2, k4, K4, k6, K56, k7, K7, k8, K8, k9A, K9a, k9B, K9b, k10, K10, k11, K11, k12, k13, k15 = params #18
    ...
    dHog1_AC = k6 * Sho1 * Hog1_IC / (K56 + Hog1_IC) - k7 * Hog1_AC / (K7 + Hog1_AC) - k8 * Hog1_AC / (K8 + Hog1_AC) + k9B * Hog1_AN / (K9b + Hog1_AN)
    dHog1_AN = k8 * Hog1_AC / (K8 + Hog1_AC) - k9B * Hog1_AN / (K9b + Hog1_AN) - k10 * Hog1_AN / (K10 + Hog1_AN)
    dHog1_IN = k10 * Hog1_AN / (K10 + Hog1_AN) - k9A * Hog1_IN / (K9a + Hog1_IN) + (k11 - (k15 * sig - Glycerol)) * Hog1_IC / (K11 + Hog1_IC)
    dGlycerol = k12 * Hog1_AC - k13 * Glycerol

    return dSho1, dHog1_AC, dHog1_AN, dHog1_IN, dGlycerol

#OptimizedModel, osmo positive inactive import
def OM_osmoimpinpos(initials,t,total_protein,sig,params, run_type=None):
    Sho1, Hog1_AC, Hog1_AN, Hog1_IN, Glycerol = initials
    Sho1_tot, Hog1_tot, _ = total_protein
    base_osmo, k2, K2, k4, K4, k6, K56, k7, K7, k8, K8, k9A, K9a, k9B, K9b, k10, K10, k11, K11, k12, k13, k15 = params #18
...
#Translocation12456
def T12456(initials,t,total_protein,sig,params, run_type=None):
    Sho1, Hog1_AC, Hog1_AN, Hog1_IN, Glycerol = initials
    Sho1_tot, Hog1_tot, _ = total_protein
    base_osmo, k10, K10, k11, K11, kA, KA, k6, K6, kB, KB, k4, K4, k1, K1, k2, K2, k5, K5, k12, k13 = params #18
    ...
    dHog1_AN = kB * Hog1_AC / (KB + Hog1_AC) - k1 * Hog1_AN / (K1 + Hog1_AN) - k2 * Hog1_AN / (K2 + Hog1_AN)
    dHog1_IN = k2 * Hog1_AN / (K2 + Hog1_AN) - k4 * Hog1_IN / (K4 + Hog1_IN) + k5 * Hog1_IC / (K5 + Hog1_IC)
    dGlycerol = k12 * Hog1_AC - k13 * Glycerol

    return dSho1, dHog1_AC, dHog1_AN, dHog1_IN, dGlycerol

#Translocation123456
def T123456(initials,t,total_protein,sig,params, run_type=None):
    Sho1, Hog1_AC, Hog1_AN, Hog1_IN, Glycerol = initials
    Sho1_tot, Hog1_tot, _ = total_protein
...
#Translocation12346
def T12346(initials,t,total_protein,sig,params, run_type=None):
    Sho1, Hog1_AC, Hog1_AN, Hog1_IN, Glycerol = initials
    Sho1_tot, Hog1_tot, _ = total_protein
    base_osmo, k10, K10, k11, K11, kA, KA, k6, K6, kB, KB, k4, K4, k1, K1, k2, K2, k12, k13, k3, K3 = params #18
    ...
    dHog1_AC = kA * Sho1 * Hog1_IC / (KA + Hog1_IC) - k6 * Hog1_AC / (K6 + Hog1_AC) - kB * Hog1_AC / (KB + Hog1_AC) + k1 * Hog1_AN / (K1 + Hog1_AN)
    dHog1_AN = kB * Hog1_AC / (KB + Hog1_AC) - k1 * Hog1_AN / (K1 + Hog1_AN) - k2 * Hog1_AN / (K2 + Hog1_AN) + k3 * Sho1 * Hog1_IN / (K3 + Hog1_IN)
    dHog1_IN = k2 * Hog1_AN / (K2 + Hog1_AN) - k4 * Hog1_IN / (K4 + Hog1_IN) - k3 * Sho1 * Hog1_IN / (K3 + Hog1_IN)
    dGlycerol = k12 * Hog1_AC - k13 * Glycerol

    return dSho1, dHog1_AC, dHog1_AN, dHog1_IN, dGlycerol

#Translocation23456
def T23456(initials,t,total_protein,sig,params, run_type=None):
    Sho1, Hog1_AC, Hog1_AN, Hog1_IN, Glycerol = initials
    Sho1_tot, Hog1_tot, _ = total_protein
...
#Translocation12356
def T12356(initials,t,total_protein,sig,params, run_type=None):
    Sho1, Hog1_AC, Hog1_AN, Hog1_IN, Glycerol = initials
    Sho1_tot, Hog1_tot, _ = total_protein
    base_osmo, k10, K10, k11, K11, kA, KA, k6, K6, kB, KB, k1, K1, k2, K2, k5, K5, k12, k13, k3, K3 = params #18
    ...
    dHog1_AC = kA * Sho1 * Hog1_IC / (KA + Hog1_IC) - k6 * Hog1_AC / (K6 + Hog1_AC) - kB * Hog1_AC / (KB + Hog1_AC) + k1 * Hog1_AN / (K1 + Hog1_AN)
    dHog1_AN = kB * Hog1_AC / (KB + Hog1_AC) - k1 * Hog1_AN / (K1 + Hog1_AN) - k2 * Hog1_AN / (K2 + Hog1_AN) + k3 * Sho1 * Hog1_IN / (K3 + Hog1_IN)
    dHog1_IN = k2 * Hog1_AN / (K2 + Hog1_AN) + k5 * Hog1_IC / (K5 + Hog1_IC) - k3 * Sho1 * Hog1_IN / (K3 + Hog1_IN)
    dGlycerol = k12 * Hog1_AC - k13 * Glycerol

    return dSho1, dHog1_AC, dHog1_AN, dHog1_IN, dGlycerol

#Translocation13456
def T13456(initials,t,total_protein,sig,params, run_type=None):
    Sho1, Hog1_AC, Hog1_AN, Hog1_IN, Glycerol = initials
    Sho1_tot, Hog1_tot, _ = total_protein
    base_osmo, k10, K10, k11, K11, kA, KA, k6, K6, kB, KB, k4, K4, k1, K1, k5, K5, k12, k13, k3, K3 = params #18
    ...
    dSho1 = (base_osmo + k10 * sig - Glycerol) * (Sho1_inactive) / (K10 + Sho1_inactive) - k11 * Sho1 / (K11 + Sho1)
    dHog1_AC = kA * Sho1 * Hog1_IC / (KA + Hog1_IC) - k6 * Hog1_AC / (K6 + Hog1_AC) - kB * Hog1_AC / (KB + Hog1_AC) + k1 * Hog1_AN / (K1 + Hog1_AN)
    dHog1_AN = kB * Hog1_AC / (KB + Hog1_AC) - k1 * Hog1_AN / (K1 + Hog1_AN) + k3 * Sho1 * Hog1_IN / (K3 + Hog1_IN)
    dHog1_IN = - k4 * Hog1_IN / (K4 + Hog1_IN) + k5 * Hog1_IC / (K5 + Hog1_IC) - k3 * Sho1 * Hog1_IN / (K3 + Hog1_IN)
    dGlycerol = k12 * Hog1_AC - k13 * Glycerol

    return dSho1, dHog1_AC, dHog1_AN, dHog1_IN, dGlycerol

#Translocation2456
def T2456(initials,t,total_protein,sig,params, run_type=None):
    Sho1, Hog1_AC, Hog1_AN, Hog1_IN, Glycerol = initials
    Sho1_tot, Hog1_tot, _ = total_protein
    base_osmo, k10, K10, k11, K11, kA, KA, k6, K6, kB, KB, k4, K4, k2, K2, k5, K5, k12, k13 = params #18
    ...
    dSho1 = (base_osmo + k10 * sig - Glycerol) * (Sho1_inactive) / (K10 + Sho1_inactive) - k11 * Sho1 / (K11 + Sho1)
    dHog1_AC = kA * Sho1 * Hog1_IC / (KA + Hog1_IC) - k6 * Hog1_AC / (K6 + Hog1_AC) - kB * Hog1_AC / (KB + Hog1_AC)
    dHog1_AN = kB * Hog1_AC / (KB + Hog1_AC) - k2 * Hog1_AN / (K2 + Hog1_AN)
    dHog1_IN = k2 * Hog1_AN / (K2 + Hog1_AN) - k4 * Hog1_IN / (K4 + Hog1_IN) + k5 * Hog1_IC / (K5 + Hog1_IC)
    dGlycerol = k12 * Hog1_AC - k13 * Glycerol
...
#Translocation2346
def T2346(initials,t,total_protein,sig,params, run_type=None):
    Sho1, Hog1_AC, Hog1_AN, Hog1_IN, Glycerol = initials
    Sho1_tot, Hog1_tot, _ = total_protein
    base_osmo, k10, K10, k11, K11, kA, KA, k6, K6, kB, KB, k4, K4, k2, K2, k12, k13, k3, K3 = params #18
...
#Translocation1456
def T1456(initials,t,total_protein,sig,params, run_type=None):
    Sho1, Hog1_AC, Hog1_AN, Hog1_IN, Glycerol = initials
    Sho1_tot, Hog1_tot, _ = total_protein
    base_osmo, k10, K10, k11, K11, kA, KA, k6, K6, kB, KB, k4, K4, k1, K1, k5, K5, k12, k13 = params #18
    ...
    dHog1_IN = - k4 * Hog1_IN / (K4 + Hog1_IN) + k5 * Hog1_IC / (K5 + Hog1_IC)
    dGlycerol = k12 * Hog1_AC - k13 * Glycerol

    return dSho1, dHog1_AC, dHog1_AN, dHog1_IN, dGlycerol

#Translocation1356
def T1356(initials,t,total_protein,sig,params, run_type=None):
    Sho1, Hog1_AC, Hog1_AN, Hog1_IN, Glycerol = initials
    Sho1_tot, Hog1_tot, _ = total_protein
    base_osmo, k10, K10, k11, K11, kA, KA, k6, K6, kB, KB, k1, K1, k5, K5, k12, k13, k3, K3 = params #18
    ...
    dHog1_AC = kA * Sho1 * Hog1_IC / (KA + Hog1_IC) - k6 * Hog1_AC / (K6 + Hog1_AC) - kB * Hog1_AC / (KB + Hog1_AC) + k1 * Hog1_AN / (K1 + Hog1_AN)
    dHog1_AN = kB * Hog1_AC / (KB + Hog1_AC) - k1 * Hog1_AN / (K1 + Hog1_AN) + k3 * Sho1 * Hog1_IN / (K3 + Hog1_IN)
    dHog1_IN = k5 * Hog1_IC / (K5 + Hog1_IC) - k3 * Sho1 * Hog1_IN / (K3 + Hog1_IN)
    dGlycerol = k12 * Hog1_AC - k13 * Glycerol

    return dSho1, dHog1_AC, dHog1_AN, dHog1_IN, dGlycerol

#Translocation1246
def T1246(initials,t,total_protein,sig,params, run_type=None):
    Sho1, Hog1_AC, Hog1_AN, Hog1_IN, Glycerol = initials
    Sho1_tot, Hog1_tot, _ = total_protein
    base_osmo, k10, K10, k11, K11, kA, KA, k6, K6, kB, KB, k4, K4, k1, K1, k2, K2, k12, k13 = params #18
    ...
    dHog1_AC = kA * Sho1 * Hog1_IC / (KA + Hog1_IC) - k6 * Hog1_AC / (K6 + Hog1_AC) - kB * Hog1_AC / (KB + Hog1_AC) + k1 * Hog1_AN / (K1 + Hog1_AN)
    dHog1_AN = kB * Hog1_AC / (KB + Hog1_AC) - k1 * Hog1_AN / (K1 + Hog1_AN) - k2 * Hog1_AN / (K2 + Hog1_AN)
    dHog1_IN = k2 * Hog1_AN / (K2 + Hog1_AN) - k4 * Hog1_IN / (K4 + Hog1_IN)
    dGlycerol = k12 * Hog1_AC - k13 * Glycerol

    return dSho1, dHog1_AC, dHog1_AN, dHog1_IN, dGlycerol

#Translocation12345
def T12345(initials,t,total_protein,sig,params, run_type=None):
    Sho1, Hog1_AC, Hog1_AN, Hog1_IN, Glycerol = initials
    Sho1_tot, Hog1_tot, _ = total_protein
    base_osmo, k10, K10, k11, K11, kA, KA, kB, KB, k4, K4, k1, K1, k2, K2, k5, K5, k12, k13, k3, K3 = params #18
    ...
    dSho1 = (base_osmo + k10 * sig - Glycerol) * (Sho1_inactive) / (K10 + Sho1_inactive) - k11 * Sho1 / (K11 + Sho1)
    dHog1_AC = kA * Sho1 * Hog1_IC / (KA + Hog1_IC) - kB * Hog1_AC / (KB + Hog1_AC) + k1 * Hog1_AN / (K1 + Hog1_AN)
    dHog1_AN = kB * Hog1_AC / (KB + Hog1_AC) - k1 * Hog1_AN / (K1 + Hog1_AN) - k2 * Hog1_AN / (K2 + Hog1_AN) + k3 * Sho1 * Hog1_IN / (K3 + Hog1_IN)
    dHog1_IN = k2 * Hog1_AN / (K2 + Hog1_AN) - k4 * Hog1_IN / (K4 + Hog1_IN) + k5 * Hog1_IC / (K5 + Hog1_IC) - k3 * Sho1 * Hog1_IN / (K3 + Hog1_IN)
    dGlycerol = k12 * Hog1_AC - k13 * Glycerol
...
#Translocation1234
def T1234(initials,t,total_protein,sig,params, run_type=None):
    Sho1, Hog1_AC, Hog1_AN, Hog1_IN, Glycerol = initials
    Sho1_tot, Hog1_tot, _ = total_protein
    base_osmo, k10, K10, k11, K11, kA, KA, kB, KB, k4, K4, k1, K1, k2, K2, k12, k13, k3, K3 = params #18
...
#Translocation1245
def T1245(initials,t,total_protein,sig,params, run_type=None):
    Sho1, Hog1_AC, Hog1_AN, Hog1_IN, Glycerol = initials
    Sho1_tot, Hog1_tot, _ = total_protein
    base_osmo, k10, K10, k11, K11, kA, KA, kB, KB, k4, K4, k1, K1, k2, K2, k5, K5, k12, k13 = params #18
...
#Translocation2345
def T2345(initials,t,total_protein,sig,params, run_type=None):
    Sho1, Hog1_AC, Hog1_AN, Hog1_IN, Glycerol = initials
    Sho1_tot, Hog1_tot, _ = total_protein
    base_osmo, k10, K10, k11, K11, kA, KA, kB, KB, k4, K4, k2, K2, k5, K5, k12, k13, k3, K3 = params #18
    ...
    dSho1 = (base_osmo + k10 * sig - Glycerol) * (Sho1_inactive) / (K10 + Sho1_inactive) - k11 * Sho1 / (K11 + Sho1)
    dHog1_AC = kA * Sho1 * Hog1_IC / (KA + Hog1_IC) - kB * Hog1_AC / (KB + Hog1_AC)
    dHog1_AN = kB * Hog1_AC / (KB + Hog1_AC) - k2 * Hog1_AN / (K2 + Hog1_AN) + k3 * Sho1 * Hog1_IN / (K3 + Hog1_IN)
    dHog1_IN = k2 * Hog1_AN / (K2 + Hog1_AN) - k4 * Hog1_IN / (K4 + Hog1_IN) + k5 * Hog1_IC / (K5 + Hog1_IC) - k3 * Sho1 * Hog1_IN / (K3 + Hog1_IN)
    dGlycerol = k12 * Hog1_AC - k13 * Glycerol
...
#Translocation1236
def T1236(initials,t,total_protein,sig,params, run_type=None):
    Sho1, Hog1_AC, Hog1_AN, Hog1_IN, Glycerol = initials
    Sho1_tot, Hog1_tot, _ = total_protein
    base_osmo, k10, K10, k11, K11, kA, KA, k6, K6, kB, KB, k1, K1, k2, K2, k12, k13, k3, K3 = params #18
    ...
    dHog1_AC = kA * Sho1 * Hog1_IC / (KA + Hog1_IC) - k6 * Hog1_AC / (K6 + Hog1_AC) - kB * Hog1_AC / (KB + Hog1_AC) + k1 * Hog1_AN / (K1 + Hog1_AN)
    dHog1_AN = kB * Hog1_AC / (KB + Hog1_AC) - k1 * Hog1_AN / (K1 + Hog1_AN) - k2 * Hog1_AN / (K2 + Hog1_AN) + k3 * Sho1 * Hog1_IN / (K3 + Hog1_IN)
    dHog1_IN = k2 * Hog1_AN / (K2 + Hog1_AN) - k3 * Sho1 * Hog1_IN / (K3 + Hog1_IN)
    dGlycerol = k12 * Hog1_AC - k13 * Glycerol

    return dSho1, dHog1_AC, dHog1_AN, dHog1_IN, dGlycerol

#Translocation124
def T124(initials,t,total_protein,sig,params, run_type=None):
    Sho1, Hog1_AC, Hog1_AN, Hog1_IN, Glycerol = initials
    Sho1_tot, Hog1_tot, _ = total_protein
    base_osmo, k10, K10, k11, K11, kA, KA, kB, KB, k4, K4, k1, K1, k2, K2, k12, k13 = params #18
...
#Translocation245
def T245(initials,t,total_protein,sig,params, run_type=None):
    Sho1, Hog1_AC, Hog1_AN, Hog1_IN, Glycerol = initials
    Sho1_tot, Hog1_tot, _ = total_protein
    base_osmo, k10, K10, k11, K11, kA, KA, kB, KB, k4, K4, k2, K2, k5, K5, k12, k13 = params #18
...
#Translocation234
def T234(initials,t,total_protein,sig,params, run_type=None):
    Sho1, Hog1_AC, Hog1_AN, Hog1_IN, Glycerol = initials
    Sho1_tot, Hog1_tot, _ = total_protein
    base_osmo, k10, K10, k11, K11, kA, KA, kB, KB, k4, K4, k2, K2, k12, k13, k3, K3 = params #18
...
#Translocation246
def T246(initials,t,total_protein,sig,params, run_type=None):
    Sho1, Hog1_AC, Hog1_AN, Hog1_IN, Glycerol = initials
    Sho1_tot, Hog1_tot, _ = total_protein
    base_osmo, k10, K10, k11, K11, kA, KA, k6, K6, kB, KB, k4, K4, k2, K2, k12, k13 = params #18
...
#Translocation24
def T24(initials,t,total_protein,sig,params, run_type=None):
    Sho1, Hog1_AC, Hog1_AN, Hog1_IN, Glycerol = initials
    Sho1_tot, Hog1_tot, _ = total_protein
    base_osmo, k10, K10, k11, K11, kA, KA, kB, KB, k4, K4, k2, K2, k12, k13 = params #18
...
#Translocation16
def T16(initials,t,total_protein,sig,params, run_type=None):
