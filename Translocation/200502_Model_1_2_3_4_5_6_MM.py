...
def model(initials, t, Hog1_tot, params, data_phospho):
    ...
    dHog1AC = kA * (Hog1IC) / (KA + Hog1IC) - kb * Hog1AC + k1 * Hog1AN - k6 * Hog1AC / (K6 + Hog1AC)
    dHog1IN = k2 * Hog1AN / (K2 + Hog1AN) - k3 * Hog1IN / (K3 + Hog1IN) - k4 * Hog1IN + k5 * Hog1IC
...
if __name__ == '__main__':
    ...
    #base filename
    save_filename = '200502_Model_1_2_3_4_5_6_MM.txt'
