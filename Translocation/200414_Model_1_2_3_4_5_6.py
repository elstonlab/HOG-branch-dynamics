...
def model(initials, t, Hog1_tot, params, data_phospho):
    Hog1AC, Hog1IN = initials
    kA, KA, kb, KB, k1, K1, k2, K2, k3, K3, k4, K4, k5, K5, k6, K6 = params #18

    Hog1A = signal(t, data_phospho)

    dHog1AC = kA * (Hog1_tot - Hog1A - Hog1IN) / (KA + (Hog1_tot - Hog1A - Hog1IN)) - kb * Hog1AC / (KB + Hog1AC) + k1 * (Hog1A - Hog1AC) / (K1 + (Hog1A - Hog1AC)) - k6 * Hog1AC / (K6 + Hog1AC)
    dHog1IN = k2 * (Hog1A - Hog1AC) / (K2 + (Hog1A - Hog1AC)) - k3 * Hog1IN / (K3 + Hog1IN) - k4 * Hog1IN / (K4 + Hog1IN) + k5 * (Hog1_tot - Hog1A - Hog1IN) / (K5 + (Hog1_tot - Hog1A - Hog1IN))

    return dHog1AC, dHog1IN
...
if __name__ == '__main__':
    ...
    #base filename
    save_filename = '200414_Model_1_2_3_4_5_6.txt'
