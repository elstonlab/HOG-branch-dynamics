...
def fit_data_to_list_nuc(model_fxns, top_params, params_constants, initials, time, param, dose, t100a=False, ptpD=False,
                        ss = False):
        sims = []
        for idx, params in enumerate(top_params):
            ss_data = run_ss(model_fxns.m, initials, params_constants, params)
...
def plt_param_cis_nuc(model_fxns, top_params, params_constants, initials,  doses, time, param,
                        exp_data=None, exp_time=None, ss=False, t100a=False, ptpD=False, ci= 95,
                        save_fig='', save_as='.pdf'):
    plt.clf()
    font = {'family' : 'Arial',
    ...
    for sig in doses:
        if t100a:
            sims = fit_data_to_list_nuc(model_fxns, top_params, params_constants, initials, time, param, sig, t100a=True, ss=ss)
        else:
            sims = fit_data_to_list_nuc(model_fxns, top_params, params_constants, initials, time, param, sig, t100a=False, ss=ss)
